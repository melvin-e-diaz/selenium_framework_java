...
public class BaseTest {
    ...
    public static String htmlReportFolder = getForwardSlash() + sdf.format(timestamp) + getForwardSlash();
    ...
    public void setup() throws Exception {
        ...
        if (!(Settings.LogPath.isEmpty())) {
            ...
            htmlReportFolder = Settings.LogPath + getForwardSlash() + sdf.format(timestamp) + getForwardSlash();
        ...
        extent.setSystemInfo("Selenium Version", "4.36.00");
    ...
    private static String getForwardSlash()
    {
        return String.valueOf(Character.toChars(47));
    }
